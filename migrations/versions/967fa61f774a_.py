...
Revision ID: 967fa61f774a
Revises: 
Create Date: 2023-12-12 08:26:33.545155
...
def upgrade():
    ...
    with op.batch_alter_table('blocklists', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_blocklists_jwt_id'), ['jwt_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('blocklists', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_blocklists_jwt_id'))
